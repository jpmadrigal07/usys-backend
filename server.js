...
const CollegeLevelRoute = require("./routes/collegeLevel")
const ShsLevelRoute = require("./routes/shsLevel")
...
app.use("/api/collegeLevel",CollegeLevelRoute);
app.use("/api/shsLevel",ShsLevelRoute);
